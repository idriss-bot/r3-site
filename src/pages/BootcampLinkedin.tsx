...
export default function BootcampLinkedin() {
        ...
        <div className="w-full max-w-5xl mx-auto">
          ...
          <div className="text-center mb-8 md:mb-10">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-light mb-4 leading-[1.15] tracking-tight">
              <span className="inline-block">Sur LinkedIn,</span>{' '}
              <span className="inline-block">vos clients vous choisissent</span>{' '}
              <span className="italic gold-gradient-text inline-block">avant même le premier rendez-vous.</span>
            </h1>
            <h2 className="text-base md:text-lg text-white/80 max-w-2xl mx-auto leading-loose font-light">
              <span className="inline-block"><mark className="bg-primary/20 text-white px-1.5 py-0.5 rounded-md font-medium">5&nbsp;leçons</mark>,</span>{' '}
              <span className="inline-block">1&nbsp;par&nbsp;jour pendant <span className="font-medium text-white">5&nbsp;jours.</span></span>{' '}
              <span className="inline-block">2&nbsp;minutes de lecture,</span>{' '}
              <span className="inline-block">dans votre boîte mail,</span>{' '}
              <span className="inline-block"><mark className="bg-primary/20 text-white px-1.5 py-0.5 rounded-md font-medium">gratuitement.</mark></span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-center">
            ...
            <div className="flex flex-col gap-4">
              <div className="rounded-2xl overflow-hidden shadow-lg">
                <img
                  src="https://pub-cafafba9e69048b58316855e8ac02b43.r2.dev/Bootcamp%20LinkedIn.png"
                  alt="Bootcamp LinkedIn de l'été — 5 leçons gratuites par email"
            ...
            <div className="glass-panel rounded-2xl p-8 md:p-10 shadow-2xl">
              {success ? (
                <div className="text-center py-6">
                  ...
                  <p className="text-gray-400 font-light text-sm">Votre première leçon arrive dans votre boîte mail. Vérifiez vos spams si besoin.</p>
                </div>
              ) : (
