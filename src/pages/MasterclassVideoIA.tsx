        ...
        <div className="w-full max-w-5xl mx-auto">
          ...
          <div className="text-center mb-8 md:mb-10">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-light mb-4 leading-[1.1] tracking-tight text-balance">
              ...
              <span className="inline-block mt-4 px-6 py-2 rounded-full text-xl md:text-2xl font-bold text-black tracking-wide shadow-lg" style={{background: 'linear-gradient(to right, #E8C396, #C28135)'}}>Mardi 19 mai 2026 à 12h</span>
            </h1>
